...
export declare class ApolloClientManager {
    ...
    getCheckout: (isUserSignedIn: boolean, channel: string, checkoutToken: string | null) => Promise<{
        data: ICheckoutModel;
        error?: undefined;
    } | {
        error: any;
    ...
    getRefreshedCheckoutLines: (checkoutlines: ICheckoutModelLine[] | null, channel: string) => Promise<{
        error: any;
        data?: undefined;
    } | {
        data: {
    ...
    createCheckout: (email: string, lines: Array<{
        variantId: string;
        quantity: number;
    }>, channel: string, shippingAddress?: ICheckoutAddress | undefined, billingAddress?: ICheckoutAddress | undefined) => Promise<{
        data: ICheckoutModel;
        error?: undefined;
    } | {
        error: any;
    ...
    setShippingAddress: (shippingAddress: ICheckoutAddress, email: string, checkoutId: string, channel: string) => Promise<{
        data: ICheckoutModel;
        error?: undefined;
    } | {
        data?: undefined;
    ...
    createPayment: ({ amount, checkoutId, gateway, token, returnUrl, }: CreatePaymentInput) => Promise<{
        data: IPaymentModel;
        error?: undefined;
    } | {
        data?: undefined;
