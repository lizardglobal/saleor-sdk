...
class SaleorState extends helpers_1.NamedObservable {
    ...
    static calculateSummaryPrices(checkout) {
        ...
        const checkoutShippingPrice = checkout === null || checkout === void 0 ? void 0 : checkout.shippingPrice;
        if (items && items.length) {
            const firstItemTotalPrice = items[0].totalPrice;
            if (firstItemTotalPrice) {
                const shippingPrice = Object.assign(Object.assign({}, shippingMethod === null || shippingMethod === void 0 ? void 0 : shippingMethod.price), { amount: (checkoutShippingPrice === null || checkoutShippingPrice === void 0 ? void 0 : checkoutShippingPrice.gross.amount) || ((_b = shippingMethod === null || shippingMethod === void 0 ? void 0 : shippingMethod.price) === null || _b === void 0 ? void 0 : _b.amount) ||
                        0, currency: ((_c = shippingMethod === null || shippingMethod === void 0 ? void 0 : shippingMethod.price) === null || _c === void 0 ? void 0 : _c.currency) ||
                ...
                const subtotalPrice = Object.assign(Object.assign({}, firstItemTotalPrice), { gross: Object.assign(Object.assign({}, firstItemTotalPrice.gross), { amount: round_1.default(itemsGrossPrice, 2) }), net: Object.assign(Object.assign({}, firstItemTotalPrice.net), { amount: round_1.default(itemsNetPrice, 2) }) });
                ...
                const totalPrice = Object.assign(Object.assign({}, subtotalPrice), { gross: Object.assign(Object.assign({}, subtotalPrice.gross), { amount: round_1.default(itemsGrossPrice + shippingPrice.amount - discount.amount, 2) }), net: Object.assign(Object.assign({}, subtotalPrice.net), { amount: round_1.default(itemsNetPrice + shippingPrice.amount - discount.amount, 2) }) });
                return {
                    discount,
                    shippingPrice,
                    subtotalPrice,
