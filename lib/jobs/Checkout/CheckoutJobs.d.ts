...
declare class CheckoutJobs extends JobsHandler<{}> {
    ...
    provideCheckout: ({ isUserSignedIn, channel, }: ProvideCheckoutJobInput) => PromiseCheckoutJobRunResponse;
    createCheckout: ({ email, lines, channel, shippingAddress, selectedShippingAddressId, billingAddress, selectedBillingAddressId, }: CreateCheckoutJobInput) => PromiseCheckoutJobRunResponse;
    setShippingAddress: ({ checkoutId, shippingAddress, email, selectedShippingAddressId, channel, }: SetShippingAddressJobInput) => PromiseCheckoutJobRunResponse;
    ...
    createPayment: ({ checkoutId, amount, gateway, token, creditCard, returnUrl, }: CreatePaymentJobInput) => PromiseCheckoutJobRunResponse;
