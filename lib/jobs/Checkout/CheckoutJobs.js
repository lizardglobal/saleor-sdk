...
class CheckoutJobs extends JobsHandler_1.JobsHandler {
    constructor(localStorageHandler, apolloClientManager) {
        super();
        this.provideCheckout = ({ isUserSignedIn, channel, }) => __awaiter(this, void 0, void 0, function* () {
            const checkout = LocalStorageHandler_1.LocalStorageHandler.getCheckout();
            const { data, error } = yield this.apolloClientManager.getCheckout(isUserSignedIn, channel, checkout === null || checkout === void 0 ? void 0 : checkout.token);
            if (error) {
                return {
                    dataError: {
                        error,
        ...
        this.createCheckout = ({ email, lines, channel, shippingAddress, selectedShippingAddressId, billingAddress, selectedBillingAddressId, }) => __awaiter(this, void 0, void 0, function* () {
            const cleanedLines = lines.filter(line => line.quantity !== 0);
            const { data, error } = yield this.apolloClientManager.createCheckout(email, cleanedLines, channel, shippingAddress, billingAddress);
            if (error) {
                /**
        ...
        this.setShippingAddress = ({ checkoutId, shippingAddress, email, selectedShippingAddressId, channel, }) => __awaiter(this, void 0, void 0, function* () {
            const checkout = LocalStorageHandler_1.LocalStorageHandler.getCheckout();
            const { data, error } = yield this.apolloClientManager.setShippingAddress(shippingAddress, email, checkoutId, channel);
            if (error) {
                return {
                    dataError: {
                        error,
            ...
            this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, checkout), { availableShippingMethods: data === null || data === void 0 ? void 0 : data.availableShippingMethods, billingAsShipping: false, email: data === null || data === void 0 ? void 0 : data.email, selectedShippingAddressId, shippingAddress: data === null || data === void 0 ? void 0 : data.shippingAddress, shippingPrice: data === null || data === void 0 ? void 0 : data.shippingPrice }));
            return { data };
        });
        this.setBillingAddress = ({ checkoutId, billingAddress, billingAsShipping, selectedBillingAddressId, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, checkout), { availablePaymentGateways: data === null || data === void 0 ? void 0 : data.availablePaymentGateways, billingAddress: data === null || data === void 0 ? void 0 : data.billingAddress, billingAsShipping: !!billingAsShipping, selectedBillingAddressId, shippingPrice: data === null || data === void 0 ? void 0 : data.shippingPrice }));
            return { data };
        });
        ...
        this.setShippingMethod = ({ checkoutId, shippingMethodId, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, checkout), { promoCodeDiscount: data === null || data === void 0 ? void 0 : data.promoCodeDiscount, shippingMethod: data === null || data === void 0 ? void 0 : data.shippingMethod, shippingPrice: data === null || data === void 0 ? void 0 : data.shippingPrice }));
            return { data };
        });
        ...
        this.createPayment = ({ checkoutId, amount, gateway, token, creditCard, returnUrl, }) => __awaiter(this, void 0, void 0, function* () {
