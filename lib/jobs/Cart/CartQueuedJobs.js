        ...
        this.setCartItem = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (checkout) {
                ...
                if (error && this.onErrorListener) {
                    ...
                    this.localStorageHandler.setCheckout(Object.assign(Object.assign({}, checkout), { availablePaymentGateways: data.availablePaymentGateways, availableShippingMethods: data.availableShippingMethods, lines: data.lines, promoCodeDiscount: data.promoCodeDiscount, shippingMethod: data.shippingMethod, shippingPrice: data.shippingPrice }));
                }
            }
        });
