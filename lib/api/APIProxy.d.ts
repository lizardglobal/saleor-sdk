...
declare class APIProxy {
    ...
    getAttributes: <TVariables extends import("../queries/gqlTypes/Attributes").AttributesVariables, TOptions extends Pick<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/Attributes").AttributesVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables"> | WatchQueryOptions<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/Attributes").AttributesVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables">>, "context" | "fetchPolicy" | "errorPolicy" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">>(variables: TVariables, options: TOptions & {
    ...
    getOrdersByUser: <TVariables extends import("../queries/gqlTypes/OrdersByUser").OrdersByUserVariables, TOptions extends Pick<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/OrdersByUser").OrdersByUserVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables"> | WatchQueryOptions<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/OrdersByUser").OrdersByUserVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables">>, "context" | "fetchPolicy" | "errorPolicy" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">>(variables: TVariables, options: TOptions & {
        skip?: boolean | undefined;
        onComplete?: (() => void) | undefined;
        onError?: ((error: ApolloError) => void) | undefined;
    ...
    getOrderDetails: (variables: InferOptions<QUERIES["OrderDetails"] | QUERIES["OrderDetailsByUser"]>["variables"], options: Pick<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/OrderByToken").OrderByTokenVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables"> | import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/UserOrderByToken").UserOrderByTokenVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables">, "context" | "fetchPolicy" | "errorPolicy" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData"> & {
        ...
        setOptions: (newOptions: Pick<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/OrderByToken").OrderByTokenVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables"> | import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/UserOrderByToken").UserOrderByTokenVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables">, "context" | "fetchPolicy" | "errorPolicy" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData"> & {
            onUpdate: (data: OrderByToken["orderByToken"] | UserOrderByToken["orderByToken"] | null) => void;
        }) => Promise<{
            data: import("../queries/gqlTypes/OrderByToken").OrderByToken_orderByToken | null;
        }>;
    ...
    getVariantsProducts: <TVariables extends import("../queries/gqlTypes/VariantsProducts").VariantsProductsVariables, TOptions extends Pick<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/VariantsProducts").VariantsProductsVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables"> | WatchQueryOptions<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<import("../queries/gqlTypes/VariantsProducts").VariantsProductsVariables>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables">>, "context" | "fetchPolicy" | "errorPolicy" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">>(variables: TVariables, options: TOptions & {
        skip?: boolean | undefined;
        onComplete?: (() => void) | undefined;
        onError?: ((error: ApolloError) => void) | undefined;
    ...
    getShopDetails: <TVariables extends null, TOptions extends Pick<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<null>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables"> | WatchQueryOptions<import("../tsHelpers").RequireOnlyOne<Pick<WatchQueryOptions<null>, "context" | "fetchPolicy" | "errorPolicy" | "variables" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">, "variables">>, "context" | "fetchPolicy" | "errorPolicy" | "fetchResults" | "metadata" | "pollInterval" | "notifyOnNetworkStatusChange" | "returnPartialData">>(variables: TVariables, options: TOptions & {
        skip?: boolean | undefined;
        onComplete?: (() => void) | undefined;
        onError?: ((error: ApolloError) => void) | undefined;
